                        ...
                        <Stack direction="row" className="shortHistory">
                            <Stack>
                                <Typography variant = "h5">
                                    {system ==="Metric"? history.day.maxtemp_c: history.day.maxtemp_f}
                                </Typography>
                                <Typography variant = "h5">
                                    {system ==="Metric"? history.day.mintemp_c: history.day.mintemp_f}
                                </Typography>
                            </Stack>
                            <Stack>
                                <img className="icon" src = {history.day.condition.icon}/>
