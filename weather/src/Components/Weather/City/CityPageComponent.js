    ...
    return(
        <div className='container'>
            <div className='buttons'>
                <Button className='city' variant="text" size="large" onClick = {onGoForecast}>{t("city.btns.forecast")}</Button>
                <Button className='city' variant="text" size="large" onClick = {onGoHistory}>{t("city.btns.history")}</Button>
                <Button className='city' variant="text" size="large" onClick = {onGoSport}>{t("city.btns.sport")}</Button>
            </div>
