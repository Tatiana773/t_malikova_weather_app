...
export const AccountSettingsComponent = () =>{
    ...
    return(
        <div className='radioGroup'>
            <div className='radio'><Radio {...controlProps('Metric')} /><Typography>Metric</Typography></div>
            <div className='radio'><Radio {...controlProps('Imperial')} /><Typography>Imperial</Typography></div>
        </div>
    )
}